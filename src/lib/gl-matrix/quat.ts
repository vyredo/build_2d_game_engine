...
export function create() {
  var out = new glMatrix.ARRAY_TYPE(4) as quat;
...
export function setAxisAngle(out: quat, axis: vec3.vec3, rad: number) {
  rad = rad * 0.5;
  var s = Math.sin(rad);
  out[0] = s * axis[0];
  out[1] = s * axis[1];
...
export function getAxisAngle(out_axis: vec3.vec3, q: quat) {
...
export function exp(out: quat, a: quat) {
  var x = a[0],
    y = a[1],
    z = a[2],
    w = a[3];
...
export function ln(out: quat, a: quat) {
  var x = a[0],
    y = a[1],
    z = a[2],
    w = a[3];
...
export function pow(out: quat, a: quat, b: number) {
  ln(out, a);
  scale(out, out, b);
  exp(out, out);
  return out;
...
export function fromMat3(out: quat, m: mat3.mat3) {
...
export var rotationTo = (function () {
  ...
  return function (out: quat, a: vec3.vec3, b: vec3.vec3) {
...
export var sqlerp = (function () {
  var temp1 = create();
  var temp2 = create();
  return function (out: quat, a: quat, b: quat, c: quat, d: quat, t: number) {
    slerp(temp1, a, d, t);
    slerp(temp2, b, c, t);
...
export var setAxes = (function () {
  ...
  return function (out: vec3.vec3, view: vec3.vec3, right: vec3.vec3, up: vec3.vec3) {
    matr[0] = right[0];
    matr[3] = right[1];
    matr[6] = right[2];
    matr[1] = up[0];
