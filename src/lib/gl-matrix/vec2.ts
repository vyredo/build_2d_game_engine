...
export class vec2 extends Float32Array {
  constructor(initial_values?: [number, number]) {
    initial_values ? super(initial_values) : super(2);
  }
}

export function create() {
  var out = new glMatrix.ARRAY_TYPE(2) as vec2;
...
export function min(out: vec2, a: vec2, b: vec2) {
...
export function max(out: vec2, a: vec2, b: vec2) {
...
export function scaleAndAdd(out: vec2, a: vec2, b: vec2, scale: number) {
  out[0] = a[0] + b[0] * scale;
  out[1] = a[1] + b[1] * scale;
  return out;
}
...
export function cross(out: vec2, a: vec2, b: vec2) {
...
export function transformMat2(out: vec2, a: vec2, m: vec2) {
  var x = a[0],
    y = a[1];
  out[0] = m[0] * x + m[2] * y;
  out[1] = m[1] * x + m[3] * y;
...
export function transformMat2d(out: vec2, a: vec2, m: vec2) {
  var x = a[0],
    y = a[1];
...
export function transformMat3(out: vec2, a: vec2, m: vec2) {
  var x = a[0],
    y = a[1];
...
export function transformMat4(out: vec2, a: vec2, m: vec2) {
  var x = a[0];
  var y = a[1];
...
export function rotate(out: vec2, a: vec2, b: vec2, rad: number) {
...
export var forEach = (function () {
  var vec = create();
  return function (a: Array<number>, stride: number, offset: number, count: number, fn: Function, arg: {}) {
    var i, l;
