...
export function create() {
  var out = new glMatrix.ARRAY_TYPE(3) as vec3;
...
export function rotateX(out: vec3, a: vec3, b: vec3, rad: number) {
  var p = [],
...
export function rotateY(out: vec3, a: vec3, b: vec3, rad: number) {
  var p = [],
    r = []; //Translate point to the origin
...
export function rotateZ(out: vec3, a: vec3, b: vec3, rad: number) {
  var p = [],
    r = []; //Translate point to the origin
